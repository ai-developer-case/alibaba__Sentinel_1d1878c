    ...
    private static boolean checkClusterField(/*@NonNull*/ FlowRule rule) {
        ...
        switch (rule.getStrategy()) {
            case ClusterRuleConstant.FLOW_CLUSTER_STRATEGY_NORMAL:
                return true;
            case ClusterRuleConstant.FLOW_CLUSTER_STRATEGY_FALLBACK_TO_LOCAL:
                return clusterConfig.getStrategy() == ClusterRuleConstant.FLOW_CLUSTER_STRATEGY_FALLBACK_TO_LOCAL;
            default:
                return false;
        }
    }
